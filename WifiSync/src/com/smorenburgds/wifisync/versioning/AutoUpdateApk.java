package com.smorenburgds.wifisync.versioning;
...
/**
 * JSON para comprobar actualizacion
 * 
 * { 
...
public class AutoUpdateApk {
	 ...
	 */
	public static final String INFO_FILE = "http://smorenburg.diskstation.me/wifisync_update.txt";
	...
	public void getData(Context context) {
		try {
			// Datos locales
			PackageInfo pckginfo = context.getPackageManager().getPackageInfo(
